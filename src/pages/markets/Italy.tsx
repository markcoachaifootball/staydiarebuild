    ...
    <div className="min-h-screen bg-staydia-black text-white">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-staydia-black/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-staydia-gold">Il Calcio Dilettantistico Italiano Merita VisibilitÃ </h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4">
              ...
              <div><h3 className="font-bold text-lg mb-2">ComunitÃ  e Monetizzazione</h3><p className="text-gray-300">Le aziende locali sponsorizzano le tue trasmissioni. I fan supportano il club.</p></div>
            </div>
          </div>
        </div>
      </section>
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-staydia-gold/10 border-t border-b border-staydia-gold/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">I club italiani stanno giÃ  trasmettendo, guadagnando e costruendo le loro comunitÃ .</p>
