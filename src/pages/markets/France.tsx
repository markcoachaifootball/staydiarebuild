    ...
    <div className="min-h-screen bg-staydia-black text-white">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">Staydia apporte le broadcasting professionnel au sport amateur fran\u00e7ais. Cam\u00e9ras IA GRATUITES. Gagnez \u20ac6,99/mois par abonnement. 100% des revenus vont \u00e0 votre club.</p>
      ...
      <section className="py-20 px-4 bg-staydia-black/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4"><Banknote className="h-8 w-8 text-staydia-gold flex-shrink-0 mt-1" /><div><h3 className="font-bold text-lg mb-2">100% des Revenus</h3><p className="text-gray-300">Chaque \u20ac6,99 d'abonnement va directement \u00e0 votre club.</p></div></div>
