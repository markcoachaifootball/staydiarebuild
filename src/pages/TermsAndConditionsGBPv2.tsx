        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 md:mb-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">
              Terms and Conditions (GBP) - V2
            </h1>
            <Button asChild className="w-full sm:w-auto">
              <a href="/documents/terms-and-conditions-gbp-v2.pdf" download="Staydia-Terms-And-Conditions-GBP-v2.pdf">
          ...
          <div className="bg-card rounded-lg shadow-lg overflow-hidden p-4 md:p-6">
            <Document
              file="/documents/terms-and-conditions-gbp-v2.pdf"
              ...
              error={
                <div className="flex flex-col items-center justify-center h-[400px] gap-4">
                  ...
                  <Button asChild><a href="/documents/terms-and-conditions-gbp-v2.pdf" download>Download PDF instead</a></Button>
                </div>
              }
            >
...
export default TermsAndConditionsGBPv2;
